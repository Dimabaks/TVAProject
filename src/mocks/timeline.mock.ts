...
export function generateMockTimeline(now = Date.now()): LogTimeline[] {
	return [
		{ id: "t1", status: "off duty", start: now - h(10), end: now - h(9) },
		{ id: "t2", status: "on duty", start: now - h(9), end: now - h(7) },
...
export function generateMockTimeline2(now = Date.now()): LogTimeline[] {
	return [
		{ id: "t1", status: "off duty", start: now - h(12), end: now - h(9) },
		{ id: "t2", status: "on duty", start: now - h(9), end: now - h(8) },
		{ id: "t3", status: "driving", start: now - h(8), end: now - h(4) },
		{ id: "t4", status: "break", start: now - h(4), end: now - h(3.5) },
		{ id: "t5", status: "driving", start: now - h(3.5), end: now - h(1) },
	];
}
